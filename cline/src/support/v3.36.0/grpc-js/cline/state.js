...
import { BrowserSettings, Viewport } from "./browser.ts";
import { Boolean, BooleanRequest, Empty, EmptyRequest, Int64Request, Metadata as Metadata1, StringRequest, } from "./common.ts";
import { apiProviderFromJSON, apiProviderToJSON, LanguageModelChatSelector, LiteLLMModelInfo, ModelsApiConfiguration, OcaModelInfo, OpenAiCompatibleModelInfo, OpenRouterModelInfo, } from "./models.ts";
...
export var OpenaiReasoningEffort;
(function (OpenaiReasoningEffort) {
    OpenaiReasoningEffort[OpenaiReasoningEffort["LOW"] = 0] = "LOW";
    OpenaiReasoningEffort[OpenaiReasoningEffort["MEDIUM"] = 1] = "MEDIUM";
    OpenaiReasoningEffort[OpenaiReasoningEffort["HIGH"] = 2] = "HIGH";
    OpenaiReasoningEffort[OpenaiReasoningEffort["MINIMAL"] = 3] = "MINIMAL";
    OpenaiReasoningEffort[OpenaiReasoningEffort["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(OpenaiReasoningEffort || (OpenaiReasoningEffort = {}));
export function openaiReasoningEffortFromJSON(object) {
    switch (object) {
        case 0:
        case "LOW":
...
export function openaiReasoningEffortToJSON(object) {
    switch (object) {
...
export var McpDisplayMode;
(function (McpDisplayMode) {
    McpDisplayMode[McpDisplayMode["RICH"] = 0] = "RICH";
    McpDisplayMode[McpDisplayMode["PLAIN"] = 1] = "PLAIN";
    McpDisplayMode[McpDisplayMode["MARKDOWN"] = 2] = "MARKDOWN";
    McpDisplayMode[McpDisplayMode["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(McpDisplayMode || (McpDisplayMode = {}));
export function mcpDisplayModeFromJSON(object) {
    switch (object) {
        case 0:
        case "RICH":
...
export function mcpDisplayModeToJSON(object) {
    switch (object) {
...
function createBaseAutoApprovalActions() {
    return {
        readFiles: undefined,
...
function createBaseAutoApprovalSettings() {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 50: {
                    ...
                    message.openaiReasoningEffort = reader.int32();
                    continue;
                }
                case 51: {
                    if (tag !== 408) {
...
function createBaseBrowserSettingsUpdate() {
    return {
        viewport: undefined,
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 11: {
                    ...
                    message.mcpDisplayMode = reader.int32();
                    continue;
                }
                case 12: {
                    if (tag !== 96) {
...
function createBaseFocusChainSettings() {
    return { enabled: false, remindClineInterval: 0 };
}
export const FocusChainSettings = {
    encode(message, writer = new BinaryWriter()) {
...
export const StateServiceService = {
    ...
    updateSettingsCli: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(UpdateSettingsRequestCli.encode(value).finish()),
        requestDeserialize: (value) => UpdateSettingsRequestCli.decode(value),
        responseSerialize: (value) => Buffer.from(Empty.encode(value).finish()),
        responseDeserialize: (value) => Empty.decode(value),
    },
    updateTaskSettings: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(UpdateTaskSettingsRequest.encode(value).finish()),
        requestDeserialize: (value) => UpdateTaskSettingsRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Empty.encode(value).finish()),
        responseDeserialize: (value) => Empty.decode(value),
    },
    updateTelemetrySetting: {
    ...
    getProcessInfo: {
        ...
        requestSerialize: (value) => Buffer.from(EmptyRequest.encode(value).finish()),
        requestDeserialize: (value) => EmptyRequest.decode(value),
        responseSerialize: (value) => Buffer.from(ProcessInfo.encode(value).finish()),
        responseDeserialize: (value) => ProcessInfo.decode(value),
    },
};
export const StateServiceClient = makeGenericClientConstructor(StateServiceService, "cline.StateService");
