...
import { BooleanRequest, BooleanResponse, Empty, EmptyRequest, Metadata as Metadata1, StringArrays, StringRequest, } from "./common.ts";
/** Enum for file search type filtering */
export var FileSearchType;
(function (FileSearchType) {
    FileSearchType[FileSearchType["FILE"] = 0] = "FILE";
    FileSearchType[FileSearchType["FOLDER"] = 1] = "FOLDER";
    FileSearchType[FileSearchType["UNRECOGNIZED"] = -1] = "UNRECOGNIZED";
})(FileSearchType || (FileSearchType = {}));
export function fileSearchTypeFromJSON(object) {
    switch (object) {
        case 0:
        case "FILE":
...
export function fileSearchTypeToJSON(object) {
    switch (object) {
...
export const FileServiceService = {
    ...
    ifFileExistsRelativePath: {
        ...
        requestSerialize: (value) => Buffer.from(StringRequest.encode(value).finish()),
        requestDeserialize: (value) => StringRequest.decode(value),
        responseSerialize: (value) => Buffer.from(BooleanResponse.encode(value).finish()),
        responseDeserialize: (value) => BooleanResponse.decode(value),
    },
    /** Open a file in editor by a relative path */
    openFileRelativePath: {
...
export const FileServiceClient = makeGenericClientConstructor(FileServiceService, "cline.FileService");
