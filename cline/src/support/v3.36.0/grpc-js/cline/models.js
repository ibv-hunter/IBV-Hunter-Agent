...
import { FieldMask } from "../google/protobuf/field_mask.ts";
import { Empty, EmptyRequest, Metadata as Metadata1, StringArray, StringRequest } from "./common.ts";
...
function createBaseSapAiCoreModelsRequest() {
...
function createBaseSapAiCoreModelDeployment() {
...
function createBaseSapAiCoreModelsResponse() {
    ...
    fromJSON(object) {
        return {
            deployments: globalThis.Array.isArray(object?.deployments)
                ? object.deployments.map((e) => SapAiCoreModelDeployment.fromJSON(e))
                : [],
...
function createBaseModelsApiSecrets() {
    return {
        apiKey: undefined,
...
function createBaseModelsApiOptions() {
    return {
        ulid: undefined,
...
export const ModelsApiOptions = {
    encode(message, writer = new BinaryWriter()) {
        ...
        Object.entries(message.openAiHeaders).forEach(([key, value]) => {
            ModelsApiOptions_OpenAiHeadersEntry.encode({ key: key, value }, writer.uint32(34).fork()).join();
        });
...
function createBaseModelsApiOptions_OpenAiHeadersEntry() {
    return { key: "", value: "" };
}
export const ModelsApiOptions_OpenAiHeadersEntry = {
    encode(message, writer = new BinaryWriter()) {
        if (message.key !== "") {
            writer.uint32(10).string(message.key);
        }
...
function createBaseUpdateApiConfigurationRequestNew() {
...
function createBaseUpdateApiConfigurationPartialRequest() {
    return { metadata: undefined, apiConfiguration: undefined, updateMask: undefined };
}
...
function createBaseOcaModelInfo() {
    return {
        maxTokens: undefined,
        contextWindow: undefined,
        supportsImages: undefined,
...
function createBaseOcaCompatibleModelInfo() {
    return { models: {}, error: undefined };
}
export const OcaCompatibleModelInfo = {
    encode(message, writer = new BinaryWriter()) {
        Object.entries(message.models).forEach(([key, value]) => {
            OcaCompatibleModelInfo_ModelsEntry.encode({ key: key, value }, writer.uint32(10).fork()).join();
        });
...
function createBaseOcaCompatibleModelInfo_ModelsEntry() {
    return { key: "", value: undefined };
}
export const OcaCompatibleModelInfo_ModelsEntry = {
    encode(message, writer = new BinaryWriter()) {
        if (message.key !== "") {
            writer.uint32(10).string(message.key);
        }
...
export const ModelsApiConfiguration = {
    encode(message, writer = new BinaryWriter()) {
        ...
        if (message.planModeHicapModelId !== undefined) {
            writer.uint32(1066).string(message.planModeHicapModelId);
        }
        if (message.planModeHicapModelInfo !== undefined) {
            OpenRouterModelInfo.encode(message.planModeHicapModelInfo, writer.uint32(1074).fork()).join();
        }
        if (message.planModeAihubmixModelId !== undefined) {
            writer.uint32(1082).string(message.planModeAihubmixModelId);
        }
        if (message.planModeAihubmixModelInfo !== undefined) {
            OpenAiCompatibleModelInfo.encode(message.planModeAihubmixModelInfo, writer.uint32(1090).fork()).join();
        }
        if (message.actModeApiProvider !== undefined) {
            writer.uint32(1600).int32(message.actModeApiProvider);
        }
        ...
        if (message.actModeHicapModelId !== undefined) {
            writer.uint32(1866).string(message.actModeHicapModelId);
        }
        if (message.actModeHicapModelInfo !== undefined) {
            OpenRouterModelInfo.encode(message.actModeHicapModelInfo, writer.uint32(1874).fork()).join();
        }
        if (message.actModeAihubmixModelId !== undefined) {
            writer.uint32(1882).string(message.actModeAihubmixModelId);
        }
        if (message.actModeAihubmixModelInfo !== undefined) {
            OpenAiCompatibleModelInfo.encode(message.actModeAihubmixModelInfo, writer.uint32(1890).fork()).join();
        }
        return writer;
    },
    decode(input, length) {
...
export const ModelsServiceService = {
    ...
    updateApiConfiguration: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(UpdateApiConfigurationRequestNew.encode(value).finish()),
        requestDeserialize: (value) => UpdateApiConfigurationRequestNew.decode(value),
        responseSerialize: (value) => Buffer.from(Empty.encode(value).finish()),
        responseDeserialize: (value) => Empty.decode(value),
    },
    /** Updates API configuration with partial values (only updates fields that are explicitly set) */
    updateApiConfigurationPartial: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(UpdateApiConfigurationPartialRequest.encode(value).finish()),
        requestDeserialize: (value) => UpdateApiConfigurationPartialRequest.decode(value),
        responseSerialize: (value) => Buffer.from(Empty.encode(value).finish()),
        responseDeserialize: (value) => Empty.decode(value),
    },
    /** Refreshes and returns Groq models */
    ...
    getSapAiCoreModels: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(SapAiCoreModelsRequest.encode(value).finish()),
        requestDeserialize: (value) => SapAiCoreModelsRequest.decode(value),
        responseSerialize: (value) => Buffer.from(SapAiCoreModelsResponse.encode(value).finish()),
        responseDeserialize: (value) => SapAiCoreModelsResponse.decode(value),
    },
    /** Fetches available models from OCA */
    refreshOcaModels: {
        ...
        requestSerialize: (value) => Buffer.from(StringRequest.encode(value).finish()),
        requestDeserialize: (value) => StringRequest.decode(value),
        responseSerialize: (value) => Buffer.from(OcaCompatibleModelInfo.encode(value).finish()),
        responseDeserialize: (value) => OcaCompatibleModelInfo.decode(value),
    },
    /** Fetches available models from AIhubmix */
    getAihubmixModels: {
...
export const ModelsServiceClient = makeGenericClientConstructor(ModelsServiceService, "cline.ModelsService");
