...
export interface UiServiceServer extends UntypedServiceImplementation {
  ...
  /** Subscribe to focus chat input events */
  subscribeToFocusChatInput: handleServerStreamingCall<EmptyRequest, Empty>;
  /** Subscribe to webview visibility change events */
...
export interface UiServiceClient extends Client {
  ...
  /** Subscribe to focus chat input events */
  subscribeToFocusChatInput(request: EmptyRequest, options?: Partial<CallOptions>): ClientReadableStream<Empty>;
  subscribeToFocusChatInput(
    request: EmptyRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
