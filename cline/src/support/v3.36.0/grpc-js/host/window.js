...
function createBaseOpenSettingsRequest() {
...
function createBaseOpenSettingsResponse() {
    return {};
}
...
function createBaseGetActiveEditorRequest() {
    return {};
}
...
function createBaseGetActiveEditorResponse() {
...
export const WindowServiceService = {
    ...
    openSettings: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(OpenSettingsRequest.encode(value).finish()),
        requestDeserialize: (value) => OpenSettingsRequest.decode(value),
        responseSerialize: (value) => Buffer.from(OpenSettingsResponse.encode(value).finish()),
        responseDeserialize: (value) => OpenSettingsResponse.decode(value),
    },
    /** Returns the open tabs. */
    getOpenTabs: {
    ...
    getActiveEditor: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(GetActiveEditorRequest.encode(value).finish()),
        requestDeserialize: (value) => GetActiveEditorRequest.decode(value),
        responseSerialize: (value) => Buffer.from(GetActiveEditorResponse.encode(value).finish()),
        responseDeserialize: (value) => GetActiveEditorResponse.decode(value),
    },
};
export const WindowServiceClient = makeGenericClientConstructor(WindowServiceService, "host.WindowService");
