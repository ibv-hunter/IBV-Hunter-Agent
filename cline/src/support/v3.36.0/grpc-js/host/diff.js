...
import { Metadata as Metadata1 } from "../cline/common.ts";
...
function createBaseCloseAllDiffsRequest() {
    return {};
}
...
function createBaseCloseAllDiffsResponse() {
    return {};
}
...
function createBaseOpenMultiFileDiffRequest() {
...
export const OpenMultiFileDiffRequest = {
    ...
    fromJSON(object) {
        return {
            ...
            diffs: globalThis.Array.isArray(object?.diffs) ? object.diffs.map((e) => ContentDiff.fromJSON(e)) : [],
        };
    },
    toJSON(message) {
        const obj = {};
...
function createBaseContentDiff() {
...
function createBaseOpenMultiFileDiffResponse() {
    return {};
}
...
export const DiffServiceService = {
    ...
    closeAllDiffs: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(CloseAllDiffsRequest.encode(value).finish()),
        requestDeserialize: (value) => CloseAllDiffsRequest.decode(value),
        responseSerialize: (value) => Buffer.from(CloseAllDiffsResponse.encode(value).finish()),
        responseDeserialize: (value) => CloseAllDiffsResponse.decode(value),
    },
    /**
     * Display a diff view comparing before/after states for multiple files.
     * Content is passed as in-memory data, not read from the file system.
    ...
    openMultiFileDiff: {
        ...
        requestStream: false,
        responseStream: false,
        requestSerialize: (value) => Buffer.from(OpenMultiFileDiffRequest.encode(value).finish()),
        requestDeserialize: (value) => OpenMultiFileDiffRequest.decode(value),
        responseSerialize: (value) => Buffer.from(OpenMultiFileDiffResponse.encode(value).finish()),
        responseDeserialize: (value) => OpenMultiFileDiffResponse.decode(value),
    },
};
export const DiffServiceClient = makeGenericClientConstructor(DiffServiceService, "host.DiffService");
